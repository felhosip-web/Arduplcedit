...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="h-16 bg-slate-900 border-b border-slate-800 px-4 flex items-center justify-between gap-3 shrink-0 select-none z-40 relative">
      {/* Brand / Classic Menu System */}
      <div className="flex items-center gap-4 shrink-0">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-sky-500 to-indigo-500 p-0.5 shadow-lg shadow-sky-500/20 shrink-0">
          ...
          <div className="hidden sm:block">
            <div className="flex items-center gap-1.5">
              <h1 className="font-bold text-slate-100 text-xs sm:text-sm tracking-wide whitespace-nowrap">
        ...
        {/* Classic Menu */}
        <div className="flex items-center gap-1 text-xs sm:text-sm font-medium text-slate-300 relative">
          {/* File Menu */}
          ...
          <div className="relative" ref={editMenuRef}>
            ...
            {editMenuOpen && (
              <div className="absolute top-full left-0 mt-1 w-52 bg-slate-800 border border-slate-700 rounded-xl shadow-xl py-1 z-[100]">
                <button
      ...
      <div className="flex-1 min-w-0 overflow-x-auto mx-2 scrollbar-none">
        <nav className="flex items-center bg-slate-950 p-1 rounded-xl border border-slate-800 shadow-inner w-max mx-auto gap-1">
          {/* 1. Létra Szerkesztő */}
          <button
            type="button"
